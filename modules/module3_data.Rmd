...
7) Create a boolean vector indicating if flight on the carrier WN (Southwest) and distance is less than 1000 miles and count how many such flights there are.
...
12) Reorder levels of dat$Dest by number of arrivals from SFO at the destinations.
